	...
	<!--additional allowance start -->
		...
		<div class="">
			...
			<table id="collapseExample" class="table_payscale table" id="demo" border="2" align="center">
				<?php foreach($records as $data):?>
					<tr>
						<th><h4>Credit Allowance: <?php echo "0";//$data->id?></h4></th>
						<th></th>
					</tr>
					<tr>
						<td><h4>City/Hill/Island Allow: 0</h4></td>
						<td><h4>Aya allowance: <?php echo "0";//$data->date_applied?></h4></td>
					</tr>

					<tr>
						<td><h4>Increment: <?php echo "0";//$data->grade;?></h4></td>
						<td><h4>Year: <?php //echo $data->Contacts?></h4></td>
					</tr>
					<tr>
						<td><h4>LPD: <?php echo "0";//$data->grade;?></h4></td>
						<td><h4>From: <?php //echo $data->Contacts?></h4></td>
						<td><h4>To: <?php //echo $data->Contacts?></h4></td>
					</tr>
				<?php endforeach;?>
			</table>
		</div>
