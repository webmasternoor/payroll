...
<div class="container">
    ...
    <?php // how to get controller function
            ...
            $MY->today() ;
             $monthe = date('Y');       
        ?>
        <button style="width:30%" type="button" class="btn btn-lg btn-primary center-block"><a href="<?php echo base_url('payroll/test_emp'); ?>" style="text-decoration:none;color:#ffffff;">Test Employee </a></button><br><br>
        <button style="width:30%" type="button" class="btn btn-lg btn-primary center-block"><a href="<?php echo base_url('payroll/setup'); ?>" style="text-decoration:none;color:#ffffff;">SETUP</a></button><br><br>
        <button style="width:30%" type="button" class="btn btn-lg btn-primary center-block"><a href="<?php echo base_url('payroll/leave_count/'.$ab=1); ?>" style="text-decoration:none;color:#ffffff;">Leave and OC </a></button><br><br>
