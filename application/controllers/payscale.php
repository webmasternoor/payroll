...
public function inventory()
{
    	...
    	public function create_grade()
	{
		if($this->session->userdata('logged_in'))
		{
		$this->form_validation->set_rules('grade','Grade','required|xss_clean|trim|max_length[10]|numeric');
		$this->form_validation->set_rules('designation','required|Designation','xss_clean|trim|alpha_numeric');
